...
///\file "electromagnetic/dEdxsim/.README.txt"
///\brief Example dEdxsim README page

/*! \page ExampledEdxsim Example dEdxsim
...
\section dEdxsim_s1 GEOMETRY DEFINITION
...
\section dEdxsim_s2 PHYSICS LIST
...
\section dEdxsim_s3 AN EVENT : THE PRIMARY GENERATOR
...
\section dEdxsim_s4 VISUALIZATION
 
 The Visualization Manager is set in the main () (see dEdxsim.cc).
...
\section dEdxsim_s6 DETECTOR RESPONSE
...
\section dEdxsim_s7 List of the built-in histograms
...
\verbatim
/analysis/setFileName  name  (default dEdxsim)
\endverbatim
...
\endverbatim
 All selected histos will be written on a file name.ascii  (default dEdxsim) 
    
\subsection dEdxsim_subs1 Using hbook format
...
\section dEdxsim_s8 GEANT4/GEANT3/DATA COMPARISON
...
\section dEdxsim_s9 HOW TO START ?
 
 - Execute dEdxsim in 'batch' mode from macro files e.g.
\verbatim
% $(G4INSTALL)/bin/$(G4SYSTEM)/dEdxsim   myMacro.mac
\endverbatim
		
 - Execute dEdxsim in 'interactive' mode with visualization e.g.
\verbatim
% $(G4INSTALL)/bin/$(G4SYSTEM)/dEdxsim
\endverbatim
